...
<script type="text/javascript" src="/Shoppingmall/buy/buyList.js"></script>
		...
		<c:if test="${ count > 0 }">
			...
			<c:forEach var="i" begin="0" end="${ buyLists.size() - 1 }">
				...
				<table>
					...
					<tr>
						<td width="150">${ buylists.getBuy_id() }</td>
						<td width="300">
							<img src="/Shoppingmall/bookImage/${ buylist.getBook_image() }" class="cartimage">${ buylist.getBook_title }
						</td>
						<td width="100">
