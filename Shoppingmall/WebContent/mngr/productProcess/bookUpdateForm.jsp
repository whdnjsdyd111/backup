...
<script type="text/javascript" src="/Shoppingmall/mngr/productProcess/bookupdate.js"></script>
		...
		<div id="bookUpdateForm" class="box">
			<ul>
				...
				<li><label for="book_content">내용</label>
					<textarea rows="13" cols="50" id="book_content" name="book_content">${ book.book_content }</textarea>
